...
printf 'Checking /Users/roger/Developer/my-opensource/67speed required files...\n'
...
printf '\nChecking /Users/roger/Developer/my-opensource/67speed required directories...\n'
...
if [ -f "package.json" ]; then
  if package_manager="$(choose_package_manager)"; then
    ...
    for script_name in check lint test build smoke release:check; do
